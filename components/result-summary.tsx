...
export default function ResultSummary({ score, total, userAnswers, questions, onRestart }: ResultSummaryProps) {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl p-8 border border-slate-200 dark:border-slate-700 mb-8 animate-in fade-in duration-500">
          <div className="text-center mb-8">
            <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-2">Quiz Complete!</h1>
            <p
              className={cn(
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-slate-50 dark:bg-slate-700 rounded-lg p-4 text-center">
              <p className="text-sm text-slate-600 dark:text-slate-400 mb-1">Percentage</p>
          ...
          <Button onClick={onRestart} className="w-full h-11 text-base font-semibold">
            Restart Quiz
          </Button>
        </div>
        ...
        <div className="space-y-4">
          ...
          {userAnswers.map((answer, index) => {
            ...
            return (
              ...
              >
                <button
                  onClick={() => setExpandedId(expandedId === answer.questionId ? null : answer.questionId)}
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <p className="text-slate-900 dark:text-white font-medium">{question.text}</p>
                    </div>
                    <ChevronDown
                      className={cn(
