        ...
        <div className="px-6 py-5 space-y-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                onClick={toggleAll}
                className={`text-xs font-medium text-amber-400 hover:text-amber-300 transition-colors rounded ${FOCUS_RING}`}
              >
            ...
            {selectedChapters.length === 0 ? (
              <p className="text-xs text-amber-400/80 bg-amber-500/10 border border-amber-500/20 rounded-xl px-3 py-2.5 mt-2">
          ...
          <div>
            ...
            {questionOptions.length === 0 ? (
              <p className="text-xs text-amber-400/80 bg-amber-500/10 border border-amber-500/20 rounded-xl px-3 py-2.5">
                Need at least {QUESTION_COUNT_OPTIONS[0]} questions — select
                more chapters.
              </p>
            ) : (
              <div className="flex flex-wrap gap-2">
                {questionOptions.map((n) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 border ${FOCUS_RING} ${
                      questionCount === n
          ...
          <div className="pt-1">
            ...
            <Button
              onClick={handleStart}
              disabled={!canStart}
              className="w-full h-11 bg-amber-500 hover:bg-amber-400 disabled:bg-slate-800 disabled:text-slate-600 disabled:border disabled:border-slate-700 text-black font-semibold text-sm rounded-xl transition-all duration-200"
            >
