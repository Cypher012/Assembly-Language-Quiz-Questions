...
const csc304Chapter4Questions: QuestionV2[] = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "This statement is true. The operating system is described as assigning resources such as memory, processors, and input/output devices to processes that need them.",
  },
  {
    id: "csc304_ch4_007",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "This statement is true. The diagram shows application programs at the top, running above the operating system, which in turn runs above the hardware at the bottom of the layered structure.",
  },
  {
    id: "csc304_ch4_026",
    course: "CSC 304",
    ...
    correctAnswer: 2,
    explanation:
      "Both statements are accurate. System programs include compilers, loaders, editors, and the operating system itself. Application programs are separately described as user-level software that perform specific tasks, a distinct layer above system programs. Since both are correct, the answer is that both apply.",
  },
  {
    id: "csc304_ch4_027",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "This statement is false. Reliability and Efficient Resource Utilization are both listed among the secondary goals of an operating system, while Security is listed among the primary goals, alongside User Convenience, Program Execution, and Resource Management.",
  },
  {
    id: "csc304_ch4_035",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      "Neither pairing is accurate. Windows OS was actually developed by Microsoft, not Apple, which instead developed macOS. Unix was instead developed originally at AT&T Bell Labs, not Microsoft. Since both pairings are inaccurate, none of these applies.",
  },
  {
    id: "csc304_ch4_045",
    course: "CSC 304",
    ...
    correctAnswer: 2,
    explanation:
      "Both statements are accurate. Linux is maintained by the open-source community, including groups like Red Hat and Canonical. Unix was separately developed originally at AT&T Bell Labs, with various commercial and open-source versions now available. Since both are correct, the answer is that both apply.",
  },
  {
    id: "csc304_ch4_046",
    course: "CSC 304",
    ...
    correctAnswer: 1,
    explanation:
      "This statement is false. Linux is also mentioned as used for personal computing, specifically for tech enthusiasts, in addition to Windows OS and macOS.",
  },
  {
    id: "csc304_ch4_047",
    course: "CSC 304",
