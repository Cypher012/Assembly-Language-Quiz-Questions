...
const csc304Chapter6Questions: QuestionV2[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "The Business Continuity vs Disaster Recovery table states disaster recovery's scope is reactive restoration, occurring when BCP fails and service is disrupted. Proactive prevention is instead the scope attributed to business continuity, not disaster recovery.",
  },
  {
    id: "csc304_ch6_007",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "The Components of Continuity Planning section lists business resumption planning, disaster recovery planning, and crisis management as the three main areas, so both named items are genuinely part of the list, making all of these correct.\n\nSince both specific options are supported by the source, neither can be selected alone, and none of these is ruled out because at least one option is true.",
  },
  {
    id: "csc304_ch6_013",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "The Business Impact Analysis section lists determining maximum allowable downtime for each process as one of its key tasks, matching this statement exactly.",
  },
  {
    id: "csc304_ch6_019",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "The Business Continuity Lifecycle section lists risk assessment, determination of recovery alternatives, recovery plan implementation, and recovery plan validation as its four phases, so risk assessment is directly supported. Marketing alignment is never mentioned anywhere in the source as a lifecycle phase.",
  },
  {
    id: "csc304_ch6_025",
    course: "CSC 304",
  ...
  },
  {
    ...
    options: [
      "Identify and quantify threats to processes",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "The Key Difference table reverses this: the backup plan's outcome is data availability, while the recovery plan's outcome is system functionality through complete system restoration. This statement swaps the two plan types' actual outcomes.",
  },
  {
    id: "csc304_ch6_031",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      "The Initial Plan Testing and Implementation section lists defining test purpose and approach as the first of six steps, followed by identifying test teams, structuring the test, conducting the test, analyzing results, and modifying plans.\n\nAnalyzing test results is listed as the fifth step, not the first.\n\nModifying plans as appropriate is listed as the sixth and final step.\n\nConducting the test is listed as the fourth step, well after the process begins.",
  },
  {
    id: "csc304_ch6_039",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "The BCP Goals section lists minimizing disruption duration and reducing recovery complexity among its four stated goals, matching this statement exactly.",
  },
  {
    id: "csc304_ch6_043",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "The Key Objectives of Contingency Plan section lists safety and well-being as protecting personnel on premises and coordination as effectively coordinating recovery tasks, so both named items are genuinely part of the list, making all of these correct.\n\nSince both specific options are supported by the source, neither can be selected alone, and none of these is ruled out because at least one option is true.",
  },
  {
    id: "csc304_ch6_049",
    course: "CSC 304",
