...
const csc304Chapter5Questions: QuestionV2[] = [
  {
    ...
    options: [
      "To meet compliance requirements and manage cybersecurity risk",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "The IS Controls section defines IS auditing as the process of reviewing implemented systems, providing consultation, and evaluating the reliability and operational effectiveness of controls, which matches this statement exactly.",
  },
  {
    id: "csc304_ch5_007",
    course: "CSC 304",
  ...
  },
  {
    ...
    options: [
      "Maintaining data integrity for system effectiveness",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "The Goals of Internal Control section lists asset safeguarding, data integrity, system efficiency, and effectiveness as the four goals, so effectiveness is directly supported. Maximizing employee overtime hours is never mentioned anywhere in the source as a goal of internal control.",
  },
  {
    id: "csc304_ch5_013",
    course: "CSC 304",
  ...
  },
  {
    ...
    options: [
      "Internal auditors add effectiveness and efficiency objectives",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "The Two Perspectives section states that effectiveness and efficiency objectives belong to the internal auditor, who adds them on top of the attest objectives. The external auditor's attest objectives are limited to asset safeguarding and data integrity only.",
  },
  {
    id: "csc304_ch5_019",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "IS Auditing Standards, consisting of 16 mandatory requirements, and IS Auditing Guidelines, consisting of 39 guidelines for applying those standards, are both genuine ISACA publications. Since both specific options are supported, neither can be selected alone, and none of these is ruled out because at least one option is true, so all of these is correct.",
  },
  {
    id: "csc304_ch5_025",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      "The IT Auditor Skills and Functions section lists risk assessment capabilities among the key skills, alongside technical knowledge, audit methodologies, business process understanding, communication, independence, and critical thinking.\n\nGraphic design expertise is not listed as a key skill in the source.\n\nUnused foreign programming syntax is not a skill described in the source.\n\nCulinary arts certification is not mentioned as a relevant skill in the source.",
  },
  {
    id: "csc304_ch5_029",
    course: "CSC 304",
    ...
    options: [
      "Assess controls and identify vulnerabilities",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "The ISACA section states that IS Auditing Guidelines consist of 39 guidelines providing guidance on applying IS auditing standards, which matches this statement exactly.",
  },
  {
    id: "csc304_ch5_031",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      "The IS Audit Process section lists exactly six phases: Scoping and Pre-Audit Survey, Planning and Preparation, Fieldwork, Analysis, Reporting, and Closure. Marketing campaign design and employee birthday scheduling do not appear among these six phases anywhere in the source, so none of these is correct.",
  },
  {
    id: "csc304_ch5_037",
    course: "CSC 304",
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "The IS Audit Process section orders the phases as Scoping and Pre-Audit Survey, Planning and Preparation, Fieldwork, Analysis, Reporting, and Closure, so Fieldwork precedes Analysis rather than following it.",
  },
  {
    id: "csc304_ch5_043",
    course: "CSC 304",
  ...
  },
  {
    ...
    options: ["Effectiveness", "Equity", "All of these", "None of these"],
    correctAnswer: 0,
    explanation:
      "The Audit Standards and Metrics section names economy, efficiency, and effectiveness as the 3 E's, so effectiveness is directly supported. Equity is never mentioned anywhere in the source as one of the 3 E's, so it cannot be included.",
  },
  {
    id: "csc304_ch5_049",
    course: "CSC 304",
