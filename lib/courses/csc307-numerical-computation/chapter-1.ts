...
export const csc307Chapter1Questions: CSC307QuestionBank = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    tokens: [
      { text: "Computation is the ", type: "content" },
      {
        text: "reduction and simplification",
        type: "content",
        blankAtLevel: 1,
      },
      { text: " of the ", type: "content" },
      { text: "mental activity", type: "content", blankAtLevel: 3 },
      { text: " of ", type: "content" },
      { text: "Ìṣirò", type: "anchor" },
      { text: " (Computing) into ", type: "content" },
      { text: "Ìlànọ̀n", type: "anchor" },
      { text: " (a Process) through an ", type: "content" },
      { text: "instrument of language", type: "content", blankAtLevel: 1 },
      { text: ". Unlike ", type: "content" },
      { text: "Ìṣẹ̀lẹ̀", type: "anchor" },
      { text: " (a happening), a process is ", type: "content" },
      {
        text: "deliberate, interruptible, reversible and repeatable",
        type: "content",
        blankAtLevel: 2,
      },
      { text: ". Computation involves the ", type: "content" },
      {
        text: "creation and manipulation of temporal and/or spatial instances",
        type: "content",
        blankAtLevel: 2,
      },
      { text: " to ", type: "content" },
      {
        text: "construe output for a valid input",
        type: "content",
        blankAtLevel: 2,
      },
      { text: ". The aspect rendered through ", type: "content" },
      { text: "digits", type: "content", blankAtLevel: 1 },
      { text: " is the focus of ", type: "content" },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    fullAnswer: `Ọ̀nkà (A Numerical-term or Number) is used to cue the logical content of Ẹyọ (a Constant).
      A numerical-term is constructed through the concatenation of finite instances of Ìka (Digit) drawn from the alphabet of a numbering scheme.
      `,
    // The substance of a number is the logic ascribed to its string of digits through a numbering scheme.
    // Precision and Constancy make numbers indispensable in Scientific and Engineering problem-solving.
    keyPoints: [
    ...
    tokens: [
      ...
      { text: " (A Numerical-term or Number) is used to ", type: "content" },
      ...
      { text: " of ", type: "content" },
      { text: "finite instances", type: "content", blankAtLevel: 3 },
      { text: " of ", type: "content" },
      { text: "Ìka", type: "anchor" },
      { text: " (Digit) drawn from the ", type: "content" },
      {
        text: "alphabet of a numbering scheme",
        type: "content",
        blankAtLevel: 2,
      },
      // { text: ". The substance of a number is the ", type: "content" },
      // {
      //   text: "logic ascribed to its string of digits",
      //   type: "content",
      //   blankAtLevel: 2,
      // },
      // { text: " through a numbering scheme. ", type: "content" },
      // { text: "Precision and Constancy", type: "content", blankAtLevel: 2 },
      // { text: " make numbers indispensable in ", type: "content" },
      // {
  ...
  // -------------------------------------------------------------------------
  {
    ...
    tokens: [
      ...
      { text: " (Half, 1/2) is the ", type: "content" },
      {
        text: "default and largest rational",
        type: "content",
        blankAtLevel: 2,
      },
      { text: " àabọ̀. ", type: "content" },
      {
  ...
  // -------------------------------------------------------------------------
  {
    ...
    tokens: [
      { text: "Polynomial (from Greek: ", type: "content" },
      { text: "'Many terms'", type: "content", blankAtLevel: 1 },
      { text: ") is the ", type: "content" },
  ...
  // -------------------------------------------------------------------------
  {
    ...
    tokens: [
      { text: "An Algorithm is a ", type: "content" },
      {
        text: "prescribed, finite, and stepwise formulation",
        type: "content",
        blankAtLevel: 1,
      },
      { text: " for reducing the ", type: "content" },
      {
        text: "mental activity of computing",
        type: "content",
        blankAtLevel: 3,
      },
      { text: " into computation through a ", type: "content" },
      ...
      { text: " (each step precisely prescribed), ", type: "content" },
